                            ...
                            if(Sequel.menyimpantf2("detail_obat_racikan","?,?,?,?,?","Data",5,new String[]{
                               ...
                               tbDetailObatRacikan.getValueAt(i,0).toString(),tbDetailObatRacikan.getValueAt(i,1).toString()
                                ...
                                if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                    ...
                                    "Ralan",kdgudang.getText(),tbDetailObatRacikan.getValueAt(i,16).toString(),tbDetailObatRacikan.getValueAt(i,17).toString(), "0", ""+Double.parseDouble(tbDetailObatRacikan.getValueAt(i,10).toString())
                                })==true){
...
//                        System.out.println("query psobat1 : " + psobat);
                        if(rsobat != null){
                            rsobat.close();
                        }
                        if(psobat != null){
...
//                        "order by databarang.nama_brng");
                    try{
                        ...
                        //System.out.println("query psobat2 : " + psobat);
                        if(rsobat != null){
                            rsobat.close();
                        }
                        if(psobat != null){
...
//                        System.out.println("query psobat3 : " + psobat);
                        if(rsobat != null){
                            rsobat.close();
                        }
                        if(psobat != null){
...
//                        System.out.println("query psobat4 : " + psobat);
                        if(rsobat != null){
                            rsobat.close();
                        }
                        if(psobat != null){
...
//                                "gudangbarang.stok>0 and data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                ...
                                //System.out.println("maaf stok 1");
                                tabModeobat.addRow(new Object[] {
                    ...
                    try{
                        ...
                        while(rsobat.next()){
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                //System.out.println("maaf stok 2");
...
//                                "gudangbarang.stok>0 and data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                //System.out.println("maaf stok 3");
                                tabModeobat.addRow(new Object[] {
                                   false,sisacari,rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                   rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(hargacari,100),
                                   rsobat.getString("nama"),0,0,sisacari,rsobat.getString("aturan_pakai"),rsobat.getString("nama_industri"),
                    ...
                    try{
                        ...
                        while(rsobat.next()){
                            ...
                            if(rsobat.getDouble("jml")>sisacari){
                                JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                //System.out.println("maaf stok 4");
                                if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                                    tabModeobat.addRow(new Object[] {false,sisacari,rsobat.getString("kode_brng"),rsobat.getString("nama_brng"),
                                       rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("karyawan"),100),
                                       rsobat.getString("nama"),0,0,sisacari,rsobat.getString("aturan_pakai"),rsobat.getString("nama_industri"),
...
//                                        "gudangbarang.stok>0 and data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
                                    ...
                                    if(rs2.getDouble("jml")>sisacari){
                                        JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                        //System.out.println("maaf stok 5");
                            ...
                            try {
                                ...
                                while(rs2.next()){
                                    ...
                                    if(rs2.getDouble("jml")>sisacari){
                                        JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                        //System.out.println("maaf stok 6");
                                        tabModeDetailObatRacikan.addRow(new Object[]{
                                            rsobat.getString("no_racik"),rs2.getString("kode_brng"),rs2.getString("nama_brng"),
...
//                                        "gudangbarang.stok>0 and data_batch.kode_brng=? and gudangbarang.kd_bangsal=? order by data_batch.tgl_kadaluarsa desc limit 1");
                                    ...
                                    if(rs2.getDouble("jml")>sisacari){
                                        JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                        //System.out.println("maaf stok 7");
                                        tabModeDetailObatRacikan.addRow(new Object[]{
                                            rsobat.getString("no_racik"),rs2.getString("kode_brng"),rs2.getString("nama_brng"),
                                            rs2.getString("kode_sat"),hargacari,h_belicari,
                                            rs2.getString("jenis"),sisacari,rs2.getDouble("kapasitas"),rs2.getString("kandungan"),
                            ...
                            try {
                                ...
                                while(rs2.next()){
                                    ...
                                    if(rs2.getDouble("jml")>sisacari){
                                        JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                        //System.out.println("maaf stok 8");
                                        if(Jeniskelas.getSelectedItem().equals("Karyawan")){
                                            tabModeDetailObatRacikan.addRow(new Object[]{
                                                rsobat.getString("no_racik"),rs2.getString("kode_brng"),rs2.getString("nama_brng"),
...
//                                    pscarikapasitas= koneksi.prepareStatement("select IFNULL(kapasitas,1) from databarang where kode_brng=?");    
                                    ...
                                    try {
                                        ...
                                        if(carikapasitas.next()){ 
                                            //System.out.println("Dlg Cari Obat tbObat: "+tbObat.getValueAt(row,1).toString()+" carikapasitas: "+carikapasitas.getDouble(1));
                                            y=Double.parseDouble(tbObat.getValueAt(row,1).toString())/carikapasitas.getDouble(1);
                                        }else{
                                            //System.out.println("Dlg Cari Obat tbObat: "+tbObat.getValueAt(row,1).toString());
                                    ...
                                    //System.out.println("Dlg Cari Obat y: "+tbObat.getValueAt(row,1).toString());
                                    y=Double.parseDouble(tbObat.getValueAt(row,1).toString());
                                }                        
                            } catch (Exception e) {
                                y=0;
...
//                    pscarikapasitas= koneksi.prepareStatement("select IFNULL(kapasitas,1) from databarang where kode_brng=?");                                      
            ...
            if(stokbarang<y){
                JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                //System.out.println("maaf stok 10");
            }
        } catch (Exception e) {
...
//                        " order by databarang.nama_brng");
        ...
        if(tbDetailObatRacikan.getSelectedRow()!= -1){
            ...
            try {
                if(Valid.SetAngka(tbDetailObatRacikan.getValueAt(row,10).toString())>0){
                    ...
                    if(stokbarang<y){
                        JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                        //System.out.println("maaf stok 11");
    ...
    private void getDatadetailobatracikan(int data) {       
        try {
            ...
            if(stokbarang<y){
                JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                //System.out.println("maaf stok 12");
            }
        } catch (Exception e) {
                ...
                try {
                    ...
                    if(rs2.next()){
                        ...
                        try {
                            ...
                            if(stokbarang<y){
                                JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                //System.out.println("maaf stok 13");
                ...
                try {
                    ...
                    if(rs2.next()){
                        ...
                        try {
                            ...
                            if(stokbarang<y){
                                JOptionPane.showMessageDialog(rootPane,"Maaf stok tidak mencukupi..!!");
                                //System.out.println("maaf stok 14");
                                tbDetailObatRacikan.setValueAt(0,tbDetailObatRacikan.getSelectedRow(),10);
                            }
                        } catch (Exception e) {
