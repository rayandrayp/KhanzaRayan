...
//        System.out.println("table obat mouse clicked");
        if(tbObat.getRowCount()!=0){
//            System.out.println("table obat mouse clicked; row cont != 0");
            try {
                getData();
...
//        System.out.println("table obat key pressed");
...
//                                    System.out.println("get data; psstok1 : "+psstok.toString());
                                ...
                                try {
                                    psstok.setString(1,kdgudang.getText());
                                    psstok.setString(2,tbObat.getValueAt(row,2).toString());
//                                    System.out.println("get data; psstok2 : "+psstok.toString());
                                    rsstok=psstok.executeQuery();
                                    if(rsstok.next()){
                                        stokbarang=rsstok.getDouble(1);
                                    }                                
...
//                            System.out.println("get data y: "+y);
//                            System.out.println("get data stokbarang : "+stokbarang);

                            //bypass by Rayan on 2022-03-11; stok boleh minus
//                            if(stokbarang<y){
...
//                            }
                        ...
                        System.out.println("get data exception : " + e.toString());
                        tbObat.setValueAt("",row,1);
                        tbObat.setValueAt(0,row,10);
                    }
//                }else{  //remarked by Rayan on 2022-03-11; karena ga jelas fungsinya buat apa???
//                    System.out.println("get data ;else");
//                    tbObat.setValueAt(0,row,10);
                }   
            }
        }            
