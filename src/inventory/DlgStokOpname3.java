 ...
 * @author dosen
 */
public final class DlgStokOpname3 extends javax.swing.JDialog {
    private final DefaultTableModel tabMode;
    private sekuel Sequel=new sekuel();
    private validasi Valid=new validasi();  
    private Connection koneksi=koneksiDB.condb();
    private PreparedStatement pstampil,ps;
    private ResultSet rstampil,rs;
     ...
     * @param parent
     * @param modal */
    public DlgStokOpname3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Object[] row={
            "NO.","NAMA MATKES","SATUAN","ED","HARGA","STOK AWAL","MASUK","KELUAR","SISA","JUMLAH"};
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tbKamar.getRowCount()==0){
            ...
            try {
                    ...
                    Logger.getLogger(DlgStokOpname3.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgStokOpname3 dialog = new DlgStokOpname3(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{     
            pstampil=koneksi.prepareStatement("SELECT d.nama_brng, k.satuan, ifnull(d.expire,'') as expire,d.h_beli,d.kode_brng " +
                                            "FROM databarang d  " +
                                            "INNER JOIN kodesatuan k ON k.kode_sat = d.kode_sat " +
                                            "WHERE d.`status`='1' AND d.kode_brng NOT IN ('','B000009066','B000009374') ORDER BY d.nama_brng asc");
            try {                    
                rstampil=pstampil.executeQuery();
                while(rstampil.next()){     
//                    System.out.println("tanggal "+tanggal);
//                    System.out.println("kode barang "+rstampil.getString("kode_brng"));
                    stok_awal=Sequel.cariIsiAngka("SELECT SUM(stok_awal) AS stok_awal \n" +
                    ...
                    masuk=Sequel.cariIsiAngka("SELECT SUM(d.jumlah) AS total FROM detailpesan d INNER JOIN pemesanan p ON p.no_faktur = d.no_faktur WHERE d.kode_brng = '"+rstampil.getString("kode_brng")+"' AND p.tgl_faktur LIKE '"+tanggal+"%'");
                    keluar=Sequel.cariIsiAngka("SELECT SUM(d.jml) AS total FROM detail_pemberian_obat d WHERE d.kode_brng = '"+rstampil.getString("kode_brng")+"' AND d.tgl_perawatan LIKE '"+tanggal+"%'");
