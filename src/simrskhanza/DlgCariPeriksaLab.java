...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    private final DefaultTableModel tabMode,tabMode2, tabModeSpuit, tabModeReagen;
    ...
    public DlgCariPeriksaLab(java.awt.Frame parent, boolean modal) {
        ...
        tabModeSpuit=new DefaultTableModel(null,new Object[]{"BPJS","DINAS","JAMKESDA","PLB"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbSpuit.setModel(tabModeSpuit);

        tbSpuit.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbSpuit.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 4; i++) {
            TableColumn column = tbSpuit.getColumnModel().getColumn(i);
            if(i==0){
                column.setPreferredWidth(100);
            }else if(i==1){
                column.setPreferredWidth(100);
        ...
        tbSpuit.setDefaultRenderer(Object.class, new WarnaTable());
        
        
        tabModeReagen=new DefaultTableModel(null,new Object[]{"Jenis Perawatan","BPJS","DINAS","JAMKESDA","PLB"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbReagen.setModel(tabModeReagen);

        tbReagen.setPreferredScrollableViewportSize(new Dimension(800,800));
        tbReagen.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);

        for (i = 0; i < 5; i++) {
            TableColumn column = tbReagen.getColumnModel().getColumn(i);
            if(i==0){
        ...
        tbReagen.setDefaultRenderer(Object.class, new WarnaTable());
    ...
    private void initComponents() {
        ...
        tbSpuit = new widget.Table();
        jScrollPane2 = new javax.swing.JScrollPane();
        tbReagen = new widget.Table();
        ...
        tbSpuit.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbSpuit.setComponentPopupMenu(jPopupMenu1);
        tbSpuit.setName("tbSpuit"); // NOI18N
        tbSpuit.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbSpuitMouseClicked(evt);
            }
        });
        tbSpuit.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbSpuitKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(tbSpuit);

        TabRawat.addTab("Laporan Spuit", jScrollPane1);

        jScrollPane2.setName("jScrollPane2"); // NOI18N

        tbReagen.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tbReagen.setComponentPopupMenu(jPopupMenu1);
        tbReagen.setName("tbReagen"); // NOI18N
        tbReagen.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbReagenMouseClicked(evt);
            }
        });
        tbReagen.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbReagenKeyPressed(evt);
            }
        });
        jScrollPane2.setViewportView(tbReagen);

        TabRawat.addTab("Laporan Reagen", jScrollPane2);
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        switch (TabRawat.getSelectedIndex()) {
            ...
            //tab laporan Spuit    
            case 3:
                if(tabModeSpuit.getRowCount()==0){
                    JOptionPane.showMessageDialog(null,"Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
                    TCari.requestFocus();
                }else if(tabModeSpuit.getRowCount()!=0){
                    
                    Sequel.queryu("truncate table temporary_lab");
                    int row=tabModeSpuit.getRowCount();
                    for(i=0;i<row;i++){
                        Sequel.menyimpan("temporary_lab","'0','"+
                                tabModeSpuit.getValueAt(i,0).toString()+"','"+
                                tabModeSpuit.getValueAt(i,1).toString()+"','"+
                                tabModeSpuit.getValueAt(i,2).toString()+"','"+
                                tabModeSpuit.getValueAt(i,3).toString()+"','"+
                                Tgl1.getSelectedItem()+"','"+
                                Tgl2.getSelectedItem()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''","Periksa Lab");
                    }
                    ...
                    param.put("emailrs",akses.getemailrs());
                    param.put("logo",Sequel.cariGambar("select logo from setting"));
                    Valid.MyReport("rptDataLabSpuit.jasper","report","::[ Laporan Penggunaan Spuit Laboratorium ]::",param);
                }   break;
            //tab laporan Reagen    
            case 4:
                if(tabModeReagen.getRowCount()==0){
                    JOptionPane.showMessageDialog(null,"Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
                    TCari.requestFocus();
                }else if(tabModeReagen.getRowCount()!=0){
                    
                    Sequel.queryu("truncate table temporary_lab");
                    int row=tabModeReagen.getRowCount();
                    for(i=0;i<row;i++){
                        Sequel.menyimpan("temporary_lab","'0','"+
                                tabModeReagen.getValueAt(i,0).toString()+"','"+
                                tabModeReagen.getValueAt(i,1).toString()+"','"+
                                tabModeReagen.getValueAt(i,2).toString()+"','"+
                                tabModeReagen.getValueAt(i,3).toString()+"','"+
                                tabModeReagen.getValueAt(i,4).toString()+"','"+
                                Tgl1.getSelectedItem()+"','"+
                                Tgl2.getSelectedItem()+"','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''","Periksa Lab");
                    }
                    ...
                    param.put("emailrs",akses.getemailrs());
                    param.put("logo",Sequel.cariGambar("select logo from setting"));
                    Valid.MyReport("rptDataLabReagen.jasper","report","::[ Laporan Penggunaan Reagen Laboratorium ]::",param);
                }   break;
            default:
                break;
        }
...
private void BtnHapusKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapusKeyPressed
    ...
    private void tbSpuitKeyPressed(java.awt.event.KeyEvent evt) {                                       
        // TODO add your handling code here:
    } 
    
    private void tbSpuitMouseClicked(java.awt.event.MouseEvent evt) {                                       
        // TODO add your handling code here:
    } 
        
    private void tbReagenKeyPressed(java.awt.event.KeyEvent evt) {                                       
        // TODO add your handling code here:
    } 
    
    private void tbReagenMouseClicked(java.awt.event.MouseEvent evt) {                                       
        // TODO add your handling code here:
    } 
    /**
    ...
    */
    ...
    private javax.swing.JTable tbReagen;
    private javax.swing.JTable tbSpuit;
    ...
    //tab laporan spuit
    private void tampilSpuit() {
        try {
            int jmlBPJS = 0, jmlDINAS = 0, jmlJAMKESDA = 0, jmlPLB = 0;
            Valid.tabelKosong(tabModeSpuit);  
//            ps=koneksi.prepareStatement(
//                    "SELECT p.png_jawab, SUM(jml_spuit) as total " +
//                    "FROM data_alkes_lab d " +
//                    "inner join reg_periksa r on r.no_rawat = d.no_rawat " +
//                    "inner join penjab p on p.kd_pj = r.kd_pj " +
//                    "WHERE d.tgl_periksa BETWEEN ? AND ? " +
//                    "AND p.status = '1' "+
//                    "GROUP BY r.kd_pj ");
            String sqlquery = "select a.kd_pj, sum(a.jml_spuit) as total, a.pasienTNI " +
                            "from ( select j.nm_perawatan, d.kd_jenis_prw, d.jml_spuit, ifnull(t.no_rkm_medis, 'x') as pasienTNI, r.kd_pj " +
                            "    from data_alkes_lab d " +
                            "    inner join jns_perawatan_lab j on j.kd_jenis_prw = d.kd_jenis_prw " +
                            "    inner join reg_periksa r on r.no_rawat = d.no_rawat " +
                            "    left join pasien_tni t on t.no_rkm_medis = r.no_rkm_medis " +
                            "    where d.tgl_periksa BETWEEN ? AND ? " +
                            "    and r.kd_pj in ('A09', 'BPJ') " +
                            ") a " +
                            "group by a.kd_pj, a.pasienTNI " +
                            "UNION " +
                            "select 'SPM', ifnull(sum(d.jml_spuit), 0), 'x' " +
                            "from data_alkes_lab d " +
                            "inner join jns_perawatan_lab j on j.kd_jenis_prw = d.kd_jenis_prw " +
                            "inner join reg_periksa r on r.no_rawat = d.no_rawat " +
                            "where d.tgl_periksa BETWEEN ? AND ? " +
                            "and r.kd_pj in ('SPM')";
            ps=koneksi.prepareStatement(sqlquery);
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                ps.setString(3,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(4,Valid.SetTgl(Tgl2.getSelectedItem()+""));
//                System.out.println("query spuit : "+ps); 
                rs=ps.executeQuery();
                while(rs.next()){
                    //"BPJS","DINAS","JAMKESDA","PLB"
                    //System.out.println("Spuit: png_jawab " + rs.getString("png_jawab") + " | total "+rs.getInt("total"));
                    
                    switch (rs.getString("kd_pj")) {
                        case "BPJ":
                            if(rs.getString("pasienTNI").equalsIgnoreCase("x")){
                                jmlBPJS += rs.getInt("total");
                            } else {
                                jmlDINAS += rs.getInt("total");
                            }
                            break;
                        case "SPM":
                            jmlJAMKESDA += rs.getInt("total");
                            break;
                        case "A09":
                            jmlPLB += rs.getInt("total");
                            break;                            
                    } 
                }
                tabModeSpuit.addRow(new String[]{
                    String.valueOf(jmlBPJS),String.valueOf(jmlDINAS),String.valueOf(jmlJAMKESDA),String.valueOf(jmlPLB)                       
                });
    ...
    private void tampilReagen() {
        try {
            int jmlBPJS = 0, jmlDINAS = 0, jmlJAMKESDA = 0, jmlPLB = 0;
            Valid.tabelKosong(tabModeReagen);  
            ps=koneksi.prepareStatement(
                    "SELECT j.nm_perawatan, d.kd_jenis_prw " +
                    "FROM periksa_lab d " +
                    "INNER JOIN jns_perawatan_lab j  ON j.kd_jenis_prw = d.kd_jenis_prw " +
                    "WHERE d.tgl_periksa BETWEEN ? AND ? " +
                    "AND d.kategori = 'PK' " +
                    "GROUP BY d.kd_jenis_prw");
            try {
                ps.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                ps.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
//                System.out.println("query reagen ps : "+ps); 
                rs=ps.executeQuery();
                while(rs.next()){
                    jmlBPJS = 0;
                    jmlDINAS = 0;
                    ...
                    jmlPLB = 0;
//                    ps2=koneksi.prepareStatement(
//                            "SELECT p.png_jawab, SUM(jml_reagen) as total " +
//                            "FROM data_alkes_lab d " +
//                            "inner join reg_periksa r on r.no_rawat = d.no_rawat " +
//                            "inner join penjab p on p.kd_pj = r.kd_pj " +
//                            "WHERE d.tgl_periksa BETWEEN ? AND ? " +
...
//                            "GROUP BY r.kd_pj ");
                    String sqlquery = "select a.kd_pj, sum(a.jml_spuit) as total, a.pasienTNI " +
                                    ...
                                    "AND d.kd_jenis_prw = ? "+
                                    "and r.kd_pj in ('SPM')";
                    ps2=koneksi.prepareStatement(sqlquery);
                    
                    try {
                        ps2.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                        ps2.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                        ps2.setString(3,rs.getString("kd_jenis_prw"));
                        ps2.setString(4,Valid.SetTgl(Tgl1.getSelectedItem()+""));
                        ps2.setString(5,Valid.SetTgl(Tgl2.getSelectedItem()+""));
                        ps2.setString(6,rs.getString("kd_jenis_prw"));
                        
//                        System.out.println("query reagen ps2 : "+ps2); 
                        rs2=ps2.executeQuery();
                        while(rs2.next()){
                            //"BPJS","DINAS","JAMKESDA","PLB"
                            //System.out.println("Spuit: png_jawab " + rs.getString("png_jawab") + " | total "+rs.getInt("total"));
                            
                            switch (rs2.getString("kd_pj")) {
                                case "BPJ":
                                    if(rs2.getString("pasienTNI").equalsIgnoreCase("x")){
                                        jmlBPJS += rs2.getInt("total");
                                    } else {
                                        jmlDINAS += rs2.getInt("total");
                                    }
                                    break;
                                case "SPM":
                                    jmlJAMKESDA += rs2.getInt("total");
                                    break;
                                case "A09":
                                    jmlPLB += rs2.getInt("total");
                                    break;                            
                            } 
                        }
                    ...
                    tabModeReagen.addRow(new String[]{
                        rs.getString("nm_perawatan"),String.valueOf(jmlBPJS),String.valueOf(jmlDINAS),String.valueOf(jmlJAMKESDA),String.valueOf(jmlPLB)                       
                    });
                }
