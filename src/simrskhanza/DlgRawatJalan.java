...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            //Added by Rayandra on 12/01/2022
            if (sukses == true){
    ...
    */
    ...
    private void SimpanPenangananDokterPetugas(){        
        try {
            ...
            Sequel.AutoComitFalse();
            sukses=true;
            boolean validasiTindakan = true;
            String tindakan = "";
            ttljmdokter=0;ttljmperawat=0;ttlkso=0;ttlpendapatan=0;ttljasasarana=0;ttlbhp=0;ttlmenejemen=0;
            for(i=0;i<tbTindakan3.getRowCount();i++){ 
                if(tbTindakan3.getValueAt(i,0).toString().equals("true")){
                    //cek tindakan sudah dientry atau belum
                    String strCekReg = "select count(no_rawat) from rawat_jl_drpr where no_rawat = '"+TNoRw.getText()+"' and kd_jenis_prw = '"+tbTindakan3.getValueAt(i,1).toString()+"'";
                    if(Sequel.cariInteger(strCekReg)>0){
                        validasiTindakan = false;
            ...
            if(validasiTindakan==false){
                String errMessage = "Tindakan " + tindakan + "sudah dimasukkan sebelumnya. System akan menyimpan tindakan yang belum ada.";
