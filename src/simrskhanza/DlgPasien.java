...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnBarcodeRM8.setText("Label RM 360");
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-04-2022" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-04-2022" }));
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(no_ktp.equals("Yes")&&(TKtp.getText().length()!=p_no_ktp)){//jika no peserta tidak sama dengan 16 digit, maka muncul notif
            Valid.textKosong(TKtp,"No.KTP/SIM harus "+p_no_ktp+" digit dan ");
        ...
        }else if(no_peserta.equals("Yes")&&(TNoPeserta.getText().length()<p_no_peserta)){//no peserta tidak boleh kurang dari 1
            Valid.textKosong(TNoPeserta,"No.Peserta Pasien minimal "+p_no_peserta+" karakter dan ");
        }else if(no_peserta.equals("Yes")&&(TNoPeserta.getText().length()>13)){//no peserta tidak boleh lebih dari 13
            Valid.textKosong(TNoPeserta,"No.Peserta Pasien tidak boleh lebih dari 13 karakter dan ");
