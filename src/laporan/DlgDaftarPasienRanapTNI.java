...
public class DlgDaftarPasienRanapTNI extends javax.swing.JDialog {
    ...
    public DlgDaftarPasienRanapTNI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        StatusRanapCB.setSelectedIndex(0);
        Object[] rowRwJlDr={"No.","No.RM","Nama Pasien","NRP/NIP","Cara Bayar","Tgl.Masuk","Tgl.Pulang","Ruangan","H.P.","Diagnosa","Pangkat","Satuan","Golongan","Jabatan"};
    ...
    private void initComponents() {
        ...
        StatusRanapCB = new widget.ComboBox();
        ...
        label9.setText("Status Ranap");
        label9.setName("label9"); // NOI18N
        label9.setPreferredSize(new java.awt.Dimension(100, 30));
        panelisi1.add(label9);

        StatusRanapCB.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua", "Sudah Pulang", "Belum Pulang"}));
        StatusRanapCB.setName("StatusRanapCB"); // NOI18N
        panelisi1.add(StatusRanapCB);
...
*/
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(int r=0;r<tabMode.getRowCount();r++){ 
                Sequel.menyimpan("temporary","'0','"+
                    ...
                    tabMode.getValueAt(r,13).toString()+"','','','','','','','','','','','','','','','','','','','','','','',''","Daftar Pasien"
                );
            }
    ...
    */
    ...
    private javax.swing.JComboBox<String> StatusRanapCB;
    ...
    private void prosesCari() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "pangkat_tni.nama_pangkat,satuan_tni.nama_satuan,golongan_tni.nama_golongan,jabatan_tni.nama_jabatan, pasien.nip "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    nrp = rs.getString("nip");
                    diagnosa = Sequel.cariIsi("select penyakit.nm_penyakit from penyakit inner join diagnosa_pasien on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where diagnosa_pasien.no_rawat=?",rs.getString("no_rawat"));
                    kamar="";
//                    if(!tglkeluar.equals("Belum Pulang")){ //commented karena ingin menampilkan kamar meskipun belum pulang
                        ps2=koneksi.prepareStatement(
...
//                    }
                    ...
                    if(StatusRanapCB.getSelectedIndex()== 1){ //sudah pulang
                        if (!tglkeluar.equalsIgnoreCase("Belum Pulang")){
                            tabMode.addRow(new String[]{
                                i+"",rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),nrp,rs.getString("png_jawab"),rs.getString("tgl_registrasi"),tglkeluar,
                                kamar,harirawat,diagnosa,rs.getString("nama_pangkat"),rs.getString("nama_satuan"),rs.getString("nama_golongan"),rs.getString("nama_jabatan")
                            });
                        }
                    } else if (StatusRanapCB.getSelectedIndex()== 2){ //belum pulang
                        if (tglkeluar.equalsIgnoreCase("Belum Pulang")){
                            tabMode.addRow(new String[]{
                                i+"",rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),nrp,rs.getString("png_jawab"),rs.getString("tgl_registrasi"),tglkeluar,
                                kamar,harirawat,diagnosa,rs.getString("nama_pangkat"),rs.getString("nama_satuan"),rs.getString("nama_golongan"),rs.getString("nama_jabatan")
