                                ...
                                try {
                                    ...
                                    if(carikapasitas.next()){ 
                                        if(Sequel.menyimpantf2("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                            ...
                                            tbObat.getValueAt(i,12).toString(),tbObat.getValueAt(i,13).toString(),"0",""+Double.parseDouble(tbObat.getValueAt(i,1).toString())
                                        })==true){
                                            if(aktifkanbatch.equals("yes")){
                                        ...
                                        if(Sequel.menyimpantf("detail_pemberian_obat","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","data",16,new String[]{
                                            ...
                                            "Ranap",lokasistok,tbObat.getValueAt(i,12).toString(),tbObat.getValueAt(i,13).toString(),"0",""+Double.parseDouble(tbObat.getValueAt(i,1).toString())
                                        })==true){
                                            if(aktifkanbatch.equals("yes")){
                                                Sequel.mengedit3("data_batch","no_batch=? and kode_brng=? and no_faktur=?","sisa=sisa-?",4,new String[]{
