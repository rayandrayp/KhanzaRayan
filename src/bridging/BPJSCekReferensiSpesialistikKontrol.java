...
public final class BPJSCekReferensiSpesialistikKontrol extends javax.swing.JDialog {
    ...
    */
    ...
    public void tampil() {
        try {
            if(koneksiDB.CONSIDAPIBPJS().toString()=="") System.out.println("Cons ID tidak ditemukan, periksa file konfigurasi database!");
	    ...
	    headers.add("X-Signature",api.getHmac(utc));
            ...
            System.out.println("user_key "+koneksiDB.USERKEYAPIBPJS());
            System.out.println("secret key "+koneksiDB.SECRETKEYAPIBPJS());
            ...
            //System.out.println("name node "+nameNode.path("code").asText().toString());
            if(nameNode.path("code").asText().equals("200")){
                ...
                if(response.path("list").isArray()){
                    ...
                    for(JsonNode list:response.path("list")){
                        //System.out.println("kode poli "+ list.path("kodePoli").asText());
                        //System.out.println("poli "+Poli.getText().toLowerCase());
